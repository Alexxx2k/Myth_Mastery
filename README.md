...
### Unit-Тестирование
Чтобы запустить ВСЕ тесты (и Unit и интеграционные), прописываем эту команду будучи в корне проекта:
```bash
./mvnw.cmd test
```

### Интеграционное тестирование
Чтобы запустить непосредственно интеграционной тестирование, покрывающее 3-ю пользовательскую историю
(Как администратор, я хочу управлять каталогом товаров (добавлять, редактировать, удалять позиции).),
выполняем эту команду:
```bash
./mvnw.cmd test -Dtest=AdminProductManagementStoryTest
```
